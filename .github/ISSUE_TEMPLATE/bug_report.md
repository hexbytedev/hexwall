---
name: Bug report
about: Report a problem with hexwall
title: '[bug] '
labels: ''
assignees: ''
...
- hexwall version or commit: [e.g. v0.0.1 or abc1234]
- Mode: [e.g. watch or enforce]
- Flags used: [e.g. `--db ... --hexwall-db ... --mode enforce --debug`]
...
- hexwall DB path: [e.g. `./hexwall.db`]
